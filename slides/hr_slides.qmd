...
format:
  revealjs:
    ...
    width: 1400
    slide-number: true
    logo: ../img/hfv_logo.jpg
title: "Hampton Roads Zoning Atlas"
author: "HousingForward Virginia"
date: 2023-10-13
title-slide-attributes: 
  data-background-image: ../img/hr/hr.jpeg
  data-background-position: center

---

## Zoning 101 {background-color="#40C0C0"}
...
[Some text about zoning]{.white_text}
...
::: {.column width="40%"}
::: incremental
-   Standardize zoning information to show how jurisdictions and the region treats housing following a national methodology
-   Help make zoning more accessible for people to understand
-   Make comparisons across jurisdictional, and even state lines
...
::: {.column width="60%"}
::: fragment
![](../img/nza.png){width="10%" fig-align="right"}
...
-   Is it **"Allowed/Conditional"**?
    -   It's by-right or as-of-right, meaning as long as it conforms to zoning and building requirements, all it takes is administrative approval.
...
The public approval process can be costly to both developers and residents.
...
::: {.column width="40%"}
-   Seniors need downsizing and active living options.
-   Millennials and younger Gen X need a reason to stay.
:::
:::
...
::: {.column width="40%"}
:::{.incremental}
-   1- and 2-person households have been increasing across the board.
:::
:::
...
-   Single-family housing or apartments make up the majority of new builds. 
-   "Missing Middle" options are missing!
...
:::{.column width="30%"}
-   Especially in areas like James City County, Williamsburg, and Surry County.
:::
...
:::{.column width="30%"}
-   Rent spiked during COVID, but continues to grow with increasing renters.
:::
...
Four out of the five couldn't afford the average rent by hundreds of dollars.
...
:::{.column width="30%"}
-   Homeownership for the typical Black and Hispanic households is out of reach.
:::
...
## Newport News welcomes the most diverse housing types by-right within the same zoning districts. {.center}
