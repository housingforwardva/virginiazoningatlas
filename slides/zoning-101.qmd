...
![](../img/sfz.png){.absolute top=0 left=0 height="700"}

::: aside
Areas of single-family homes and all other types of homes in Minneapolis via [New York Times](https://www.nytimes.com/interactive/2019/06/18/upshot/cities-across-america-question-single-family-zoning.html)
:::
...
[State code grants localities broad powers to regulate land uses if they:]{.fragment}
...
![](../img/use-table.jpg){.absolute top=0 left=0 height="600"}
...
[[**By-right**]{style="color:#3a9f9c"}<br>Meet all the requirements and all you need is a building permit. No special approval or public hearing required.]{.fragment}

[[**Special use permit**]{style="color:#e66b3f"}<br>Submit an application for an otherwise unallowable use, to be reviewed by staff and go to planning commission and legislative body for approval at public hearings.]{.fragment}

## What can you do with your property?

[[**Zoning variance**]{style="color:#9691cf"}<br>Submit request for exemption from specific aspect of zoning ordinance, to be reviewed and approved by board of zoning appeals.]{.fragment}

[[**Other conditions**]{style="color:#1a3454"}<br>Proposals for certain development scenarios may also require site plans, subdivision plats, and other materials to be reviewed and approved by the local government.]{.fragment}

# Before you zone out...

## The good {.center}

[:heavy_check_mark: Allows communities to effectively guide their growth]{.fragment .fade-in-then-semi-out}

[:heavy_check_mark: Offers residents opportunities to get involved in their communities]{.fragment .fade-in-then-semi-out}

[:heavy_check_mark: Can prevent unwise developments]{.fragment .fade-in-then-semi-out}

## The bad {.center}

[:x: Regulations can be complex and burdensome]{.fragment .fade-in-then-semi-out}

[:x: Zoning remains highly exclusionary in many places]{.fragment .fade-in-then-semi-out}

[:x: Minority of loud residents have veto pathway]{.fragment .fade-in-then-semi-out}
