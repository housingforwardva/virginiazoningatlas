...
rva_var_price <- read_rds("data/planrva/rds/rva_var.rds") |> 
  ...
  group_by(name) |> 
  mutate(
    prev_year_price = lag(med_price, n = 4),
    yoy_change = (med_price - prev_year_price) / prev_year_price
  ) |> 
 ...
 ggplot(rva_var_price,
  ...
  filter(period == "2024 Q2" | period == "2014 Q2") |> 
...
subtitle_text <- "In <span style = 'color:#011E41'><b>Q2 2014</b></span> and <span style = 'color:#40C0C0'><b>Q2 2024</span>"
