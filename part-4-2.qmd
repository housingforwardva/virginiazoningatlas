...
ggplot(sfd_locality,
       aes(x = reorder(jurisdiction, pct),
           y = pct)) +
  geom_col_interactive(position = "dodge", fill = "#40c0c0") +
  geom_text(aes(label = percent(pct, 1)), color = "#40c0c0",
    hjust = -0.2) +
  theme_hfv(base_size = 15) +
  coord_flip() +
...
ggplot(transit_area,
  ...
  labs(title = "Multifamily housing near transit",
       subtitle = "Percent of multifamily zoned land that permits it by-right w/in a quarter mile of transit stops")
