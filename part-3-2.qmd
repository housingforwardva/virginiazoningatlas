...
nova_sfd <- read_rds("data/nova/rds/nova_vza_nogeo.rds") |> # Read in the data.
  ...
  filter(sfd == "t") |> 
  add_row(jurisdiction = "Arlington", sfd = "t", "acres" = 0, percent = 0, total_nova = 658342.5) |> 
  add_row(jurisdiction = "Dumfries", sfd = "t", "acres" = 0, percent = 0, total_nova = 658342.5) |> 
  add_row(jurisdiction = "Haymarket", sfd = "t", "acres" = 0, percent = 0, total_nova = 658342.5) |> 
  add_row(jurisdiction = "Herndon", sfd = "t", "acres" = 0, percent = 0, total_nova = 658342.5) 
...
# Read in data frame
nova_bipoc <- read_rds("data/nova/rds/nova_bipoc.rds") |>
  st_drop_geometry() |>
  arrange(name_long) |>
...
write_csv(nova_lots, "data/nova/csv/nova_min1_lots.csv")
...
nova_byr4 <- read_rds("data/nova/rds/nova_byr4_map.rds") 
