...
nova_jhf <- read_rds("data/nova/rds/nova_ratio.rds") 
...
nova_blk_grps <- read_rds("data/nova/rds/nova_blk_grps.rds")
...
nova_occ <- read_rds("data/nova/rds/nova_occ.rds") |> 
...
nova_income <- read_rds("data/nova/rds/nova_income.rds") |> 
...
nova_cb <- read_rds("data/nova/rds/nova_cb.rds")|> 
...
nova_race_inc <- read_rds("data/nova/rds/nova_b19013.rds") |> 
  filter(year == 2022)
