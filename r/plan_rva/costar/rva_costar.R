...
rva_costar <- read_excel("data/planrva/csv/rva_multifamily_costar.xlsx") |> # Load in xlsx spreadsheet from CoStar.
...
rva_costar <- rva_costar |> 
  left_join(cpi_ls, by = "period") |> 
  transform(adj_price = (284.16933/cpi)*rent) 


write_rds(rva_costar, "data/planrva/rds/rva_costar.rds")
