...
# Data from CoStar was downloaded on 9.7.2023

hr_costar <- read_excel("data/hr/hr_costar_rent_market.xlsx") |> # Load in xlsx spreadsheet from CoStar.
...
hr_costar <- hr_costar |> 
  ...
  transform(adj_price = (278.47967/cpi)*rent) 
