...
-   Mixed with Residential zoning districts make up a small percentage of zoned land in most jurisdictions and only 3 percent (3%) of total developable land in the region.
...
![The City of Williamsburg by type of zoning district](img/williamsburg_highlight.png){fig-align="center"}

***Surry County and Southampton County have no zoning districts that allow for a mix of residential and nonresidential uses.***

![Surry County by type of zoning district](img/surry_highlight.png){fig-align="center"}

![Southampton County by type of zoning district](img/southampton_highlight.png){fig-align="center"}
...
![Intersection of Colley Ave and W. 23rd Street in Norfolk](img/colley_23rd_norfolk.png)
...
While there are constraints to downtown development in places like Newport News, increasing mixed use zoning

![Downtown Newport News](img/downtown_newportnews.png)
...
![Where 4+-Family is allowed by-right in Hampton](img/hampton_highlight.png)
...
![Where 4+-Family is allowed by-right in Virginia Beach](img/vb_highlight.png)
...
To provide a clearer picture for those that think more of ADUs as being strictly tied to single-family housing, we can exclude Mixed with Residential and Nonresidential districts. The figure below shows the percentage of developable land that allows for ADUs by-right in Primarily Residential districts.
...
![Where ADUs are allowed by-right, excluding Mixed with Residential and Nonresidential Districts](img/adu_highlight.png){fig-align="center"}
...
The map below shows Census Block Groups where more the jobs-housing fit ratio is greater than 2.0 (i.e. where there are more than two low-wage workers for every unit of affordable rental housing) or NA (i.e. where there are no units affordable to low-wage workers). And it shows where 4+ family housing can be built by-right.
...
There are many areas of the region where 4+ family must go through the public approval process, particularly in areas where it is needed the most. The public approval process for denser and more affordable housing options often faces opposition from Not-in-My-Backyard (NIMBY) residents. These opponents, often the most vocal in the room, can influence elected officials in the face of the overwhelming need among low- and moderate-income residents in the region. 
